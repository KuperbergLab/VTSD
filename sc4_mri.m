...
VTSD('ATLLoc_SC',subject,'MRI',ATLLocList,1);
fprintf('\nPress any key to continue to the next experiment...');
KbStrokeWait;

VTSD('MaskedMM_SC',subject,'MRI',MaskedMMList,1);
fprintf('\nPress any key to continue to the next experiment...');
KbStrokeWait;

VTSD('MaskedMM_SC',subject,'MRI',MaskedMMList,2);
fprintf('\nPress any key to continue to the next experiment...');
KbStrokeWait;
...
VTSD('AXCPT_SC',subject,'MRI',AXCPTList,1);
fprintf('\nPress any key to continue to the next experiment...');
KbStrokeWait;
 
VTSD('AXCPT_SC',subject,'MRI',AXCPTList,2);
fprintf('\nPress any key to continue to the next experiment...');
KbStrokeWait;

VTSD('AXCPT_SC',subject,'MRI',AXCPTList,3);
